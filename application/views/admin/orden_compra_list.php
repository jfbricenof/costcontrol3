            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <div class="box-footer clearfix">
                        <a class="btn btn-success pull-right" href="<?php echo base_url().'admin/orden_compra/nueva_orden';?>" role="button">Crear Orden de Compra</a>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="pull-right">
                                                            <a href="<?php echo base_url().'admin/orden_compra/consultar/'.$orden->id_OrdenCompra; ?>" class="btn btn-sm btn-default anular_orden" data-url="" title="Ver"><span class="fa fa-eye"></span></a>
