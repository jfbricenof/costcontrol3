...
<head>
    ...
    <title>Gestión Residencial | Ingreso Usuarios</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-logo">
            <a href="#"><b>Gestión </b>Residencial</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <h4>Inicia sesión para comenzar tu sesión</h4>
            <?php if ($this->session->flashdata("error")): ?>
            <div class="alert alert-danger">
                <p><?php echo $this->session->flashdata("error"); ?></p>
            </div>
            <?php endif ?>
            <form method="POST" action="<?php echo base_url().'loginuser/validar';?>">
                <div class="form-group <?php echo form_error("dni") != false ? 'has-error':''; ?>">
                    <input type="number" class="form-control " name="dni" placeholder="# cedula">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    <?php echo form_error("dni","<div class='text-danger'>","</div>") ?>
                </div>
